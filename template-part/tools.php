<section class="ori-tools">
    ...
    <div class="modal modal-sm">
        ...
        <div class="modal-container">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary confirm"><?php echo __(
                  '确认',
                  'origami'
                ); ?></button>
                <button class="btn btn-link cancel"><?php echo __(
                  '取消',
                  'origami'
                ); ?></button>
            </div>
  ...
  'origami'
        ...
        <a class="btn" href="javascript:toStart();"><?php echo __(
          '是',
          'oirgami'
        ); ?></a>
    </div>
    <div id="live-chat">
        ...
        <div class="live-chat-input">
            ...
            <input type="text" class="form-input" placeholder="<?php echo __(
              '输入昵称与大佬们交流',
              'oirgami'
            ); ?>">
            <button class="btn"><?php echo __(
              '开始搞事',
              'oirgami'
            ); ?></button>
        </div>
    ...
    <div class="ori-tools-btns">
        <div id="toc-btn" class="<?php echo get_option(
          'origami_sidebar_toc',
          'false'
        ); ?>" title="<?php echo __(
  '显示文章目录(点击显示或隐藏)',
  'origami'
        ...
        <div id="paper-plane" title="<?php echo __(
          '乘上通往云端的纸飞机吧',
          'origami'
        ); ?>">
    ...
    <div class="modal share-card">
        ...
        <div class="modal-container">
            ...
            <div class="modal-footer">
                <span>长按/右键保存分享</span>
                <button class="btn btn-link"><?php echo __(
                  '关闭',
                  'origami'
                ); ?></button>
            </div>
    ...
    <div class="paper-plane-mask">
        <div class="paper-plane-content">
            <div class="paper-plane-title"><?php echo __(
              '更换主题',
              'origami'
            ); ?></div>
