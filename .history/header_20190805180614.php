...
if (get_option('origami_header_icon') != "") {
  $oriLogo = get_option('origami_header_icon');
} else {
  $oriLogo = 'https://blog.ixk.me/wp-content/uploads/2018/05/blog-44.png';
} ?>
