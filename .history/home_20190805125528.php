    ...
    <div class="carousel">
        ...
        <div class="carousel-container">
            <figure class="carousel-item">
                ...
                <img class="img-responsive rounded" src="https://blog.ixk.me/bing-api.php?size=1024x768&day=1" alt="macOS Yosemite Wallpaper">
            </figure>
            <figure class="carousel-item">
                ...
                <img class="img-responsive rounded" src="https://blog.ixk.me/bing-api.php?size=1024x768&day=2" alt="macOS Yosemite Wallpaper">
            </figure>
            <figure class="carousel-item">
                ...
                <img class="img-responsive rounded" src="https://blog.ixk.me/bing-api.php?size=1024x768&day=3" alt="macOS El Capitan Wallpaper">
            </figure>
            <figure class="carousel-item">
                ...
                <img class="img-responsive rounded" src="https://blog.ixk.me/bing-api.php?size=1024x768&day=4" alt="macOS El Capitan Wallpaper">
            </figure>
        </div>
