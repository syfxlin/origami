		...
		<div id="header-middle" class="header-style">
			<div class="container">
				<div class="medium-header-container clearfix">
					...
					?>
					<a href="<?php echo esc_url(home_url('/')); ?>" id="site-logo" <?php if($is_home){echo 'style="display:none"';} ?>>
						<img src="<?php echo esc_url($site_logo); ?>" alt="Site Logo" style="width:44px;height:44px">
					</a>
					<?php if($is_home) { ?>
						<a href="<?php echo esc_url(home_url('/')); ?>" id="site-title"><?php echo get_bloginfo('name'); ?></a>
					<?php } ?>
