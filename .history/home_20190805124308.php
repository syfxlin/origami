...
<main id="main-content">
    <section class="featured-section">
        <div class="featured-slide" style="height:<?php echo '100vh'; ?>;background-image:url('<?php if (
  get_option('origami_start_image_url') != ''
) {
  ...
  echo 'https://blog.ixk.me/bing-api.php?size=1024x768&day=1';
            ...
            <div class="featured-content-area featured-content-area-home">
                <h2 class="font-montserrat-reg"><?php echo get_option(
                  'origami_start_image_title'
                ); ?></h2>
                <p class="font-opensans-reg"><?php echo get_option(
